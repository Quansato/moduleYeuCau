...
(function() {
  this.jKanban = function() {
    ...
    //customItem
    function __buildItemTitle(content) {
      var result = content;
      if (self.options.itemHandleOptions.enabled) {
        if ((self.options.itemHandleOptions.customHandler || undefined) === undefined) {
          ...
          //result = '<div class="board-task item_handle"><div><a href="" class="dispath">089423</a><span class="maunhat">giao cho </span><span class="nguoidonvigiao">ngaydas</span><span class="maunhat">bởi </span><span class="nguoidonvithuchien">qdqw</span></div><div class="infor-more">Nội dung:</div><div class="infor-more">Từ <span class="fromDate">07/08/2020</span> đến <span class="toDate">09/02/2020</span></div></div>'
          result = "<div class='item_handle "+customCssHandler+"'><i class='item_handle "+customCssIconHandler+"'></i></div><div>" + result + "</div>";
